from registration_email_only.tests.utils import GetUsernameCreatorTests, UtilsTests
from registration_email_only.tests.views import RegisterTests, ActivateTests
...
#
# from registration_email_only.backends.views import RegisterView, ActivateView
...
#         SessionMiddleware().process_request(self.req)
#         self.b = ActivateView()
#         self.u = RegisterView().register(self.req, email='this@that.com')
...
#     urls = 'registration_email_only.backends.urls'
